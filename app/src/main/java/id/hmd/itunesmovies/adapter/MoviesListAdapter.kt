...
class MoviesListAdapter(private val obj: ArrayList<ResultsItem>) : RecyclerView.Adapter<MoviesListAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.tvMovieslistItemName.text= obj[position].trackName
        holder.binding.tvMovieslistItemMerchant.text= obj[position].primaryGenreName
        holder.binding.tvMovieslistItemPoints.text= obj[position].trackPrice.toString() +" ${obj[position].currency}"
